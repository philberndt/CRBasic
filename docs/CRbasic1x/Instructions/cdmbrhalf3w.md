# CDM_BrHalf3W (CDM 3-Wire Half Bridge Measurement)

The CDM_BrHalf3W instruction is used to make a 3 wire half bridge measurement on aCDM **Note:** . For additional information on controller area network peripherals and Campbell modules, see [CPI and CDM](https://www.campbellsci.com/news-cpi-cdm).
...
The following program shows the use of the CDM_BrHalf3W instruction to measure a PRT sensor.
...
CDM_BrHalf3W(CDM_A108,1,HBr3W,1,mv200,1,X1,1,2500,True,0,60,100,0.0)
PRT (RTD_C,1,HBr3W,1.0,0)
...
For the CDM_BrHalf3W instruction, measurements are made on consecutive channels. If the Reps parameter is greater than 1, the Dest parameter must be a variable array.
