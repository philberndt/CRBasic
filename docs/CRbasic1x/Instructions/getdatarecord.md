...
Local Datalogger Program,CR1000X
...
Scan (10,Sec,3,0)
Battery (BattV)
GetDataRecord(Result,COMC1,0,3000,0000,0,2,1,TempDat,1)
NextScan
EndProg
```
...
```
'If we wish to have another datalogger, like aCR1000X,
...
'since 1 Jan 1990. TheCR1000Xis expecting an 8-byte timestamp
...
Scan (10,Sec,3,0)
Battery (BattV)
GetDataRecord(ResultTD,COMC1,0,8,0000,0,2,1,TempDat,1)
If TimeIntoInterval (10,300,Sec)
GetDataRecord(ResultTD5Min,COMC1,0,8,0000,0,2,32770,TempDat5Min,1)
EndIf
NextScan
EndProg
