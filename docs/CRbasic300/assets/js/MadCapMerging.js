...
function CMCHelpSystem(parentSubsystem, parentPath, xmlFile, tocPath, browseSequencePath) {
  ...
  this.Load = function (OnCompleteFunc) {
    CMCXmlParser.GetXmlDoc(
      ...
      function (xmlDoc) {
        ...
        mSelf.UseCustomTopicFileExtension = FMCGetAttributeBool(
        ...
        mSelf.DisplayCommunitySearchResults = FMCGetAttributeBool(
          xmlDoc.documentElement,
          "DisplayCommunitySearchResults",
          true
        );
        mSelf.CommunitySearchResultsCount = FMCGetAttributeInt(
          xmlDoc.documentElement,
        ...
        if (subsystemsNodes.length > 0 && subsystemsNodes[0].getElementsByTagName("Url").length > 0) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            var subHelpSystem = new CMCHelpSystem(
              mSelf,
              mPath + subPath,
              mPath + subPath + "Data/HelpSystem.xml",
              tocPath,
              browseSequencePath
            );
  ...
  this.LookupCSHID = function (id, OnCompleteFunc) {
    ...
    mAliasFile.Load(function () {
      ...
      if (cshIDInfo.Found) {
        if (cshIDInfo.Topic != null) cshIDInfo.Topic = mSelf.GetPath() + cshIDInfo.Topic;
  ...
  this.GetIndex = function (onCompleteFunc, onCompleteArgs) {
    if (!this.IsWebHelpPlus) {
        ...
        if (!preMerged && mSubsystems.length != 0) {
          LoadEntireIndex(function (xmlDoc) {
            function OnGetMergedIndexComplete(xmlDoc2) {
              MergeIndexEntries(
                xmlDoc.getElementsByTagName("IndexEntry")[0],
                xmlDoc2.getElementsByTagName("IndexEntry")[0]
              );
      ...
      var xmlDoc = CMCXmlParser.CallWebService(
        MCGlobals.RootFolder + "Service/Service.asmx/GetIndex",
        true,
        OnGetIndexComplete,
        null
      );
  ...
  this.GetConceptsLinks = function (conceptTerms, callbackFunc, callbackArgs) {
    if (this.IsWebHelpPlus) {
      ...
      var xmlDoc = CMCXmlParser.CallWebService(
        MCGlobals.RootFolder + "Service/Service.asmx/GetTopicsForConcepts?Concepts=" + conceptTerms,
        true,
        OnGetTopicsForConceptsComplete,
        null
      );
    } else {
      var links = null;
  ...
  this.LoadGlossary = function (onCompleteFunc, onCompleteArgs) {
    if (!this.IsWebHelpPlus) {
      ...
      var xmlDoc = CMCXmlParser.CallWebService(
        MCGlobals.RootFolder + "Service/Service.asmx/GetGlossary",
        true,
        OnGetGlossaryComplete,
        null
      );
    }
  };
  ...
  function GetGlossaryUrl(xmlDoc) {
    ...
    if (glossaryUrlRel == null) return null;
    ...
    var xmlDoc2 = subsystem.GetGlossary(function (xmlDoc2) {
      ...
      if (body1.getElementsByTagName("div").length == 0) {
        ...
        for (var i = 0, j = 0; i < body1.childNodes.length && j < body2.childNodes.length; ) {
          ...
          var term1 = currGlossaryPageEntry1.getElementsByTagName("div")[0].getElementsByTagName("a")[0]
            .firstChild.nodeValue;
          var term2 = currGlossaryPageEntry2.getElementsByTagName("div")[0].getElementsByTagName("a")[0]
            .firstChild.nodeValue;
...
function CMCTocFile(helpSystem, tocType) {
  ...
  this.LoadToc = function (xmlFile, OnCompleteFunc) {
    ...
    if (mTocType == EMCTocType.Toc && masterHS.IsWebHelpPlus) {
      xmlDoc = CMCXmlParser.CallWebService(
        mHelpSystem.GetPath() + "Service/Service.asmx/GetToc",
        true,
        OnTocXmlLoaded,
        null
      );
      ...
      xmlDoc = CMCXmlParser.CallWebService(
        mHelpSystem.GetPath() + "Service/Service.asmx/GetBrowseSequences",
        true,
        OnTocXmlLoaded,
        null
      );
  ...
  this.GetTocNode = function (tocPath, href, onCompleteFunc) {
    ...
    function CheckChunk(tocNode) {
      ...
      if (chunk != null) {
        mSelf.LoadChunk(tocNode, chunk, function (tocNode) {
    ...
    function CheckMerge(tocNode) {
      ...
      if (mergeHint >= 0) {
        mSelf.LoadMerge(tocNode, function (tocNode) {
          mSelf.GetTocNode(mTocPath, mTocHref, onCompleteFunc);
        });
  ...
  function GetTocPath(tocNode) {
    ...
    for (
      var currNode = tocNode.parentNode;
      currNode != null && currNode.parentNode.nodeType == 1;
      currNode = currNode.parentNode
    ) {
      if (tocPath == null) {
        tocPath = "";
