...
function Toolbar_LoadSkin(OnCompleteFunc) {
  FMCGetSkin(function (xmlDoc) {
    ...
    if (MCGlobals.NavigationFrame != null) {
      if (
        !gIsTopicToolbar &&
        (toolbarNode == null || !FMCGetAttributeBool(toolbarNode, "ExcludeAccordionTitle", gIsTopicToolbar))
      ) {
    ...
    if (!MCGlobals.InPreviewMode) {
      var isWebHelpPlus =
        document.documentElement.getAttribute("TargetType") == "WebHelpPlus" &&
        document.location.protocol.StartsWith("http", false);
      var logoName = isWebHelpPlus ? "LogoPlus.png" : FMCIsHtmlHelp() ? "LogoHtmlHelp.png" : "Logo.png";

      gAboutBoxURL =
        document.location.href.substring(0, document.location.href.lastIndexOf("/")) + "/Images/" + logoName;
    }
      ...
      function OnGetButtonsForToolbarProxyComplete(buttonList) {
        ...
        if (!MCGlobals.InPreviewMode && !FMCIsHtmlHelp() && !FMCIsDotNetHelp()) {
          FMCPostMessageRequest(
            MCGlobals.RootFrame,
            "subscribe-change-navigation-state-started",
            null,
            function (data) {
          ...
          FMCPostMessageRequest(
            MCGlobals.RootFrame,
            "subscribe-change-navigation-state-completed",
            null,
            function (data) {
          ...
          FMCPostMessageRequest(
            MCGlobals.RootFrame,
            "subscribe-changing-navigation-state",
            null,
            function (data) {
          ...
          gOnunloadFuncs.push(function () {
            FMCPostMessageRequest(
              MCGlobals.RootFrame,
              "unsubscribe-change-navigation-state-started",
              [gChangeNavigationStateStartedEventID],
              null,
              function () {
            ...
            FMCPostMessageRequest(
              MCGlobals.RootFrame,
              "unsubscribe-change-navigation-state-completed",
              [gChangeNavigationStateCompletedEventID],
              null,
              function () {
                MCGlobals.RootFrame.gChangeNavigationStateCompletedListeners.RemoveValue(
                  OnChangeNavigationStateCompleted
                );
              }
            );
            FMCPostMessageRequest(
              MCGlobals.RootFrame,
              "unsubscribe-changing-navigation-state",
              [gChangingNavigationStateEventID],
              null,
              function () {
        ...
        for (var i = 0; i < buttons.length; i++) {
          ...
          switch (controlType) {
            case "TopicRatings":
              ...
              CMCFlareStylesheet.SetImageFromStylesheet(
                img,
                "ToolbarItem",
                "TopicRatings",
                "EmptyIcon",
            ...
            case "EditUserProfile":
              ...
              MakeButton(
                td,
                "Edit User Profile",
                "Images/EditUserProfile.gif",
                "Images/EditUserProfile_over.gif",
                "Images/EditUserProfile_selected.gif",
                23,
                22,
                null
              );
            ...
            case "AddTopicToFavorites":
              ...
              MakeButton(
                ...
                "Images/AddTopicToFavorites.gif",
                "Images/AddTopicToFavorites_over.gif",
                "Images/AddTopicToFavorites_selected.gif",
                23,
                22,
                null
              );
            ...
            case "ToggleNavigationPane":
              ...
              MakeButton(
                ...
                title,
                outImage,
                "Images/HideNavigation_over.gif",
                "Images/HideNavigation_selected.gif",
                23,
                22,
                null
              );
            ...
            case "ExpandAll":
              MakeButton(
                ...
                "Expand all",
                "Images/Expand.gif",
                "Images/Expand_over.gif",
                "Images/Expand_selected.gif",
                23,
                22,
                null
              );

              td.getElementsByTagName("button")[0].onclick = function (e) {
                ExpandAll("open");
              };
            ...
            case "CollapseAll":
              MakeButton(
                ...
                "Collapse all",
                "Images/Collapse.gif",
                "Images/Collapse_over.gif",
                "Images/Collapse_selected.gif",
                23,
                22,
                null
              );
            ...
            case "Print":
              MakeButton(
                ...
                "Print topic",
                "Images/Print.gif",
                "Images/Print_over.gif",
                "Images/Print_selected.gif",
                23,
                22,
                null
              );
            ...
            case "QuickSearch":
              ...
              MakeButton(
                ...
                "Images/QuickSearch_over.gif",
                "Images/QuickSearch_selected.gif",
                23,
                22,
                null
              );
            ...
            case "RemoveHighlight":
              MakeButton(
                ...
                "Images/Highlight_over.gif",
                "Images/Highlight_selected.gif",
                23,
                22,
                null
              );
            ...
            case "Forward":
              MakeButton(
                ...
                "Forward",
                "Images/Forward.gif",
                "Images/Forward_over.gif",
                "Images/Forward_selected.gif",
                23,
                22,
                null
              );
            ...
            case "Stop":
              MakeButton(
                ...
                "Stop",
                "Images/Stop.gif",
                "Images/Stop_over.gif",
                "Images/Stop_selected.gif",
                23,
                22,
                null
              );
            ...
            case "Refresh":
              MakeButton(
                ...
                "Refresh",
                "Images/Refresh.gif",
                "Images/Refresh_over.gif",
                "Images/Refresh_selected.gif",
                23,
                22,
                null
              );
            ...
            case "SelectTOC":
              ...
              MakeButton(
                td,
                gTocTitle,
                "Images/SelectToc.gif",
                "Images/SelectToc_over.gif",
                "Images/SelectToc_selected.gif",
                23,
                22,
                null
              );
            ...
            case "SelectIndex":
              ...
              MakeButton(
                td,
                gIndexTitle,
                "Images/SelectIndex.gif",
                "Images/SelectIndex_over.gif",
                "Images/SelectIndex_selected.gif",
                23,
                22,
                null
              );
            ...
            case "SelectSearch":
              ...
              MakeButton(
                td,
                gSearchTitle,
                "Images/SelectSearch.gif",
                "Images/SelectSearch_over.gif",
                "Images/SelectSearch_selected.gif",
                23,
                22,
                null
              );
            ...
            case "SelectGlossary":
              ...
              MakeButton(
                td,
                gGlossaryTitle,
                "Images/SelectGlossary.gif",
                "Images/SelectGlossary_over.gif",
                "Images/SelectGlossary_selected.gif",
                23,
                22,
                null
              );
            ...
            case "SelectFavorites":
              ...
              MakeButton(
                td,
                gFavoritesTitle,
                "Images/SelectFavorites.gif",
                "Images/SelectFavorites_over.gif",
                "Images/SelectFavorites_selected.gif",
                23,
                22,
                null
              );
            ...
            case "SelectBrowseSequence":
              ...
              MakeButton(
                td,
                gBrowseSequencesTitle,
                "Images/SelectBrowsesequences.gif",
                "Images/SelectBrowsesequences_over.gif",
                "Images/SelectBrowsesequences_selected.gif",
                23,
                22,
                null
              );
            ...
            case "SelectCommunity":
              ...
              MakeButton(
                ...
                "Images/Community_over.gif",
                "Images/Community_selected.gif",
                23,
                22,
                null
              );
            ...
            case "PreviousTopic":
              MakeButton(
                td,
                "Previous Topic",
                "Images/PreviousTopic.gif",
                "Images/PreviousTopic_over.gif",
                "Images/PreviousTopic_selected.gif",
                23,
                22,
                null
              );
            ...
            case "NextTopic":
              MakeButton(
                td,
                "Next Topic",
                "Images/NextTopic.gif",
                "Images/NextTopic_over.gif",
                "Images/NextTopic_selected.gif",
                23,
                22,
                null
              );
...
function ApplyStyleToControl(div, button, toolbarStyleMap, isToggle) {
  ...
  props.ForEach(function (key, value) {
    ...
    if (propName == "Label") {
      ...
      if (button == "Separator" || button == "CurrentTopicIndex") return true;
    ...
    if ((!gIsTopicToolbar && name == "Toolbar") || (gIsTopicToolbar && name == "TopicToolbar")) {
      ...
      for (var j = 0; j < properties.length; j++) {
        ...
        if (propName == "BackgroundGradient") {
          document.body.style.backgroundImage = FMCCreateCssUrl(
            "../" + FMCGetSkinFolder() + (gIsTopicToolbar ? "Topic" : "") + "ToolbarBackground.jpg"
          );
...
function Toolbar_LoadWebHelpOptions(xmlDoc) {
  ...
  if (MCGlobals.NavigationFrame != null) {
    ...
    if (webHelpOptions) {
      ...
      if (navPanePosition) gNavPosition = navPanePosition;
    ...
    function (data) {
      ...
      FMCPostMessageRequest(
        ...
        function (data) {
          ...
          FMCPostMessageRequest(
            MCGlobals.NavigationFrame.frames["favorites"],
            "add-topic-favorite",
            [value],
            null,
            null
...
function DisplayAbout() {
  FMCPostMessageRequest(
    MCGlobals.BodyFrame,
    "display-about",
    [gAboutBoxURL, gAboutBoxAlternateText, gAboutBoxWidth, gAboutBoxHeight],
    null,
    function () {
