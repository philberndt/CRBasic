...
(function () {
  ...
  MadCap.IsSafari = function () {
    return (
      MadCap.String.Contains(navigator.userAgent, "safari") && !MadCap.String.Contains(navigator.userAgent, "chrome")
    );
  };
})();
...
(function () {
  ...
  S.ToInt = function (str, defaultValue) {
    ...
    if (str != null) intValue = parseInt(str);
  ...
  S.LocaleCompare = function (str1, str2, lang) {
    if (lang) {
      if (typeof Intl !== "undefined" && typeof Intl.Collator !== "undefined") {
        ...
        if (col) return col.compare(str1, str2);
      }
      if (String.prototype.localeCompare) return str1.localeCompare(str2, lang);
    }
