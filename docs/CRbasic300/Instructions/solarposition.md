...
The following is aCR300 Seriesprogram example using the SolarPosition instruction. This same program can be used for other dataloggers with little or no modification (check parameters that may vary for dataloggers, such as voltage ranges).
...
TCDiff (airtemp,1,mv34,1,TypeT,RefTemp,True,0,4000,1.0,0)
