...
**NOTE:** ModbusSlave() is being replaced by ModbusServer(). ModbusSlave will be deprecated in 2023 and will no longer appear in CRBasic.Beginning with OS11.0, programs should be updated to use the [ModbusServer](modbusserver.md) instruction.
