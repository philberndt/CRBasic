...
Before compiling the program, open the Customize Constants window (as shown previously), select the constant values you want to compile into the program, and then perform the **Conditional Compile and Save**.[See alsoCompile Menu.](compilemenu.md)
```
