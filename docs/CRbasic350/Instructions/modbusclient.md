...
'Main Program
BeginProg
'OpenCom3for MODBUS RS-485 communications at 19200 baud, 8 data bits, even parity, and one stop bit
SerialOpen (Com3,19200,2,100,100,4)
'Main Scan
Scan (10,Sec,1,0)
...
ModbusClient(CS250DM_ResultCode,Com3,19200,1,4,CS250DMData(),1,5,3,10,2)
