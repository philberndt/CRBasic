...
The following is aCR350 Seriesprogram example using the SolarPosition instruction. This same program can be used for other dataloggers with little or no modification (check parameters that may vary for dataloggers, such as voltage ranges).
