  ...
  e.fn.fitVids = function (t) {
    ...
    return this.each(function () {
      ...
      r.each(function () {
        ...
        var n =
            t.attr("height") && !isNaN(parseInt(t.attr("height"), 10)) ? parseInt(t.attr("height"), 10) : t.height(),
...
!(function (t) {
  ...
  t.fn.MCSlider = function (n) {
    ...
    var a = t(window).width(),
      ...
      c = function () {
        (r.wrap('<div class="mc-wrapper"><div class="mc-viewport ' + o.settings.slideshowClass + '"></div></div>'),
          (o.viewport = r.parent()),
          (o.loader = t('<div class="mc-loading" />')),
          ...
          (o.controls.el = t('<div class="mc-controls" />')),
      ...
      g = function (n, i) {
        var o = n.find('img:not([src=""])').length;
      ...
      h = function () {
        if (o.settings.infiniteLoop && "fade" != o.settings.mode && !o.settings.ticker) {
          var e = "vertical" == o.settings.mode ? o.settings.minSlides : o.settings.maxSlides,
            i = o.children.slice(0, e).clone().addClass("mc-clone").attr("aria-hidden", true),
            s = o.children.slice(-e).clone().addClass("mc-clone").attr("aria-hidden", true);
        ...
        (o.loader.remove(),
          ...
          (o.initialized = !0),
          o.settings.responsive && t(window).on("resize", B),
            ...
            "slide" == e
              ...
              : "reset" == e
                ...
                : "ticker" == e &&
                  ...
                  r.css(o.animProp, n),
                  r.on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function () {
                    (r.off("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd"),
      ...
      w = function () {
        for (var e = "", i = x(), s = 0; i > s; s++) {
          ...
          (o.settings.buildPager && t.isFunction(o.settings.buildPager)
            ? ((n = o.settings.buildPager(s)), o.pagerEl.addClass("mc-custom-pager"))
            : ((n = s + 1), o.pagerEl.addClass("mc-default-pager")),
            (e +=
      ...
      T = function () {
        (o.settings.pagerCustom
          ...
          : ((o.pagerEl = t('<div class="mc-pager" />')),
            o.settings.pagerSelector
              ? t(o.settings.pagerSelector).html(o.pagerEl)
              : o.controls.el.addClass("mc-has-pager").append(o.pagerEl),
            w()),
          o.pagerEl.on("click", "a", q));
      },
      C = function () {
        ((o.controls.next = t('<a class="mc-next">' + o.settings.nextText + "</a>")),
          (o.controls.prev = t('<a class="mc-prev">' + o.settings.prevText + "</a>")),
          o.controls.next.on("click", y),
          o.controls.prev.on("click", z),
          o.settings.nextSelector && t(o.settings.nextSelector).append(o.controls.next),
          o.settings.prevSelector && t(o.settings.prevSelector).append(o.controls.prev),
          o.settings.nextSelector ||
            o.settings.prevSelector ||
            ((o.controls.directionEl = t('<div class="mc-controls-direction" />')),
            o.controls.directionEl.append(o.controls.prev).append(o.controls.next),
            o.controls.el.addClass("mc-has-controls-direction").append(o.controls.directionEl)));
      },
      E = function () {
        ((o.controls.start = t(
          '<div class="mc-controls-auto-item"><a class="mc-start">' + o.settings.startText + "</a></div>"
        )),
          (o.controls.stop = t(
            '<div class="mc-controls-auto-item"><a class="mc-stop">' + o.settings.stopText + "</a></div>"
          )),
          (o.controls.autoEl = t('<div class="mc-controls-auto" />')),
          o.controls.autoEl.on("click", ".mc-start", k),
          o.controls.autoEl.on("click", ".mc-stop", M),
          ...
          o.settings.autoControlsSelector
            ...
            : o.controls.el.addClass("mc-has-controls-auto").append(o.controls.autoEl),
          A(o.settings.autoStart ? "stop" : "start"));
      },
      P = function () {
        o.children.each(function () {
          var e = t(this).attr("title");
          void 0 != e && ("" + e).length && t(this).append('<div class="mc-caption"><div>' + e + "</div></div>");
        });
      },
      y = function (t) {
      ...
      A = function (t) {
        o.settings.autoControlsCombine
          ...
          : (o.controls.autoEl.find("a").removeClass("active"),
            o.controls.autoEl.find("a:not(.mc-" + t + ")").addClass("active"));
      },
      W = function () {
        1 == x()
      ...
      L = function () {
        ...
        if ("next" == o.settings.autoDirection)
          r.append(o.children.clone().addClass("mc-clone").attr("aria-hidden", true));
        else {
          r.prepend(o.children.clone().addClass("mc-clone"));
      ...
      N = function (t) {
        ...
        "next" == o.settings.autoDirection
          ? (e = r.find(".mc-clone").first().position())
      ...
      O = function () {
        ((o.touch = { start: { x: 0, y: 0 }, end: { x: 0, y: 0 } }), o.viewport.on("touchstart", X));
      },
      X = function (t) {
        if (o.working) t.preventDefault();
          ...
          ((o.touch.start.x = e.changedTouches[0].pageX),
            ...
            o.viewport.on("touchmove", Y),
            o.viewport.on("touchend", V));
        }
      },
      Y = function (t) {
        var e = t.originalEvent,
    ...
    return (
          ...
          if (
            ...
            if (!o.settings.infiniteLoop && o.carousel && o.active.last)
              ...
              var d =
                ...
                a = r.children(".mc-clone").eq(d);
              n = a.position();
            } else if ("next" == i && 0 == o.active.index)
              ((n = r.find("> .mc-clone").eq(o.settings.maxSlides).position()), (o.active.last = !1));
            else if (e >= 0) {
              var c = e * m();
      ...
      (r.redrawSlider = function () {
        (o.children.add(r.find(".mc-clone")).outerWidth(u()),
      ...
      (r.destroySlider = function () {
        o.initialized &&
          ...
          t(".mc-caption", this).remove(),
          o.controls.autoEl && o.controls.autoEl.remove(),
          clearInterval(o.interval),
          o.settings.responsive && t(window).off("resize", B));
      }),
...
(function () {
  ...
  Slideshow.Init = function (context) {
    ...
    $(".MCSlider", context).each(function (index, el) {
      ...
      // General
      if (slideshowClass) options.slideshowClass = slideshowClass;

      if (randomStart) {
        if ("true" == randomStart.toString().toLowerCase()) options.randomStart = true;
        else if ("false" == randomStart.toString().toLowerCase()) options.randomStart = false;
      }
      if (infiniteLoop) {
      ...
      if (showCaptions) {
        if ("true" == showCaptions.toString().toLowerCase()) options.captions = true;
        else if ("false" == showCaptions.toString().toLowerCase()) options.captions = false;
      }
      if (controls) {
        if ("true" == controls.toString().toLowerCase()) options.controls = true;
        else if ("false" == controls.toString().toLowerCase()) options.controls = false;
      }
      options.pager = pager;
      options.thumbnails = thumbnails;
      if (width) options.slideWidth = width;
      if (height) {
        if ("true" == height.toString().toLowerCase()) options.adaptiveHeight = true;
        else if ("false" == height.toString().toLowerCase()) options.adaptiveHeight = false;
      }
      if (responsive) {
        if ("true" == responsive.toString().toLowerCase()) options.responsive = true;
        else if ("false" == responsive.toString().toLowerCase()) options.responsive = false;
      }
      ...
      if (autoHover) {
        if ("true" == autoHover.toString().toLowerCase()) {
          ...
          auto = true;
        } else if ("false" == autoHover.toString().toLowerCase()) options.autoHover = false;
      }
      if (autoStart) {
        if ("true" == autoStart.toString().toLowerCase()) {
          options.autoStart = true;
          auto = true;
        } else if ("false" == autoStart.toString().toLowerCase()) options.autoStart = false;
      }
      if (autoControls) {
      ...
      if (autoDirection) options.autoDirection = autoDirection;
      if (autoDelay) options.autoDelay = autoDelay;
      if (mode) options.mode = mode;
      if (speed) options.speed = speed;
      if (pause) options.pause = pause;
      if (minSlides) {
        ...
        MadCap.Utilities.MessageBus.PostMessageRequest(parent, "get-href", null, function (data) {
          if (data) {
            ...
            if (hash) {
              ...
              try {
                options.startSlide = $("[name=" + hash + "]")
                  .closest(".MCSlide")
                  .index();

                if (options.startSlide < 0) options.startSlide = 0;
              } catch (err) {
          ...
          $el.MCSlider(options);
          if (MadCap.Accessibility) MadCap.Accessibility.makeAccessibleMCSlideshow(context);
        });
      } else {
        $el.MCSlider(options);
        if (MadCap.Accessibility) MadCap.Accessibility.makeAccessibleMCSlideshow(context);
